...
var stripe = Stripe('pk_test_51I2fYGKpTBadwjvwTw6sGihgTKCIqOENF1XQSq1y7vrABHQeobmNRIbotVMSGPbbyCmlEv3ENozDCKNQnhuYH7BM006nY33QkM');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            _context.t0 = _context["catch"](0);
            //console.log(err);
            (0, _showAlert.showAlert)('error', _context.t0);
